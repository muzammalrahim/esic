...
// Create our image tag
        ...
        this.$editor.append($('<label class="editlabel" for="link">Add Image Class:</label>'));
        this.$editor.append($('<input>', {type: 'text', class: 'st-input-string js-source-input', name: 'image_class', placeholder: '', style: 'width: 100%; margin-top:10px; text-align: center;', value: data.image_class}));
    },
