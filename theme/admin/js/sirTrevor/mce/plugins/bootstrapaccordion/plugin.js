tinymce.PluginManager.add('bootstrapaccordion', function(editor, url) {
	...
	function accordionDialog() {
			...
			editor.windowManager.open({
				title:  'Accordion use to hide answer content',
				url: url + '/dialog.php',
				width: 900,
				height: 550,
				buttons: [
							...
							var accordion =
								'<div class="panel panel-default bootstrap-accordion">' +
									'<div class="panel-heading" role="tab" id="heading-' + timestamp + '">' +
										'<h4 class="panel-title" data-toggle="tooltip" title="Click to show/hide Answer">' +
											'<a role="button" class="bootstrap-accordion-title" data-toggle="collapse" data-parent="#accordion" href="#collapse-' + timestamp + '">' +
												accordionTitle +
											'</a>' +
								            '<a type="button" data-toggle="tooltip" title="Click to show/hide Answer"   style ="font-size:30px;margin-top:-10px;" class="pull-right" data-toggle="collapse" data-target="#collapse-' + timestamp + '">+</a>' +
										'</h4>' +
                                	'</div>' +
