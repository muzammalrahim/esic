$(function(){
    if($("#TaxAdvisorsList").length > 0){
        oTable = "";
        var regTableSelector = $("#TaxAdvisorsList");
        var url_DT = baseUrl + "admin/manage_taxadvisors/listing";
        var aoColumns_DT = [
            {
                "mData": "ID",
                "bSortable": false,
            ...
            /* ID */ {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        return '<a href="'+base_url+'admin/TaxAdvisors/view/'+full.ID+'" >'+full.ID+'</a>';
                    }
                    return data;
            ...
            /* Name */ {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        ...
                        return '<a class="list-name" href="'+base_url+'admin/TaxAdvisors/view/'+full.ID+'" >'+FullName+'</a>'+$newVer;
                    }
                    return data;
            ...
            // Website Address
            {
                "mData": "Website",
                "render": function(data, type, full){
                    var $website = full.Website;
                    if (full.New_Ver == 'Yes' && full.isAdmin == 'no') {
                        if (full.vr_Website!=null)
        ...
        sTable = $('#TaxAdvisorsList').DataTable();  // // Search by Title
