    ...
    if($("#GrantConsultantList").length > 0){
            ...
            /* Name */ {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        ...
                        return '<a class="list-name" href="'+base_url+'admin/GrantConsultant/view/'+full.ID+'" >'+$FullName+'</a>'+$newVer;
                    }
                    return data;
        ...
        $('#searchbyName').keyup(function(){
            if($('.nav-tabs li:first-child').hasClass('active'))
                sTable = $('#GrantConsultantList').DataTable();
            else
                sTable = $('#GrantConsultantStatus').DataTable();
...
$(function(){
    if($("#GrantConsultantStatus").length > 0){
        oTable = "";
        var regTableSelector = $("#GrantConsultantStatus");
        var url_DT = baseUrl + "Admin/GrantConsultant/prevStatus";
        var aoColumns_DT = [
            /* ID */ {
                "mData": "ID",
                "bVisible": true,
