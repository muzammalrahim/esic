        ...
        var aoColumns_DT = [
            ...
            /* Name */ {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        ...
                        return '<a class="list-name" href="'+base_url+'admin/Investor/view/'+full.ID+'" >'+$name+'</a>'+$newVer;
                    }
                    return data;
            ...
            //Phone or Cell
            {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        if(full.New_Ver == 'Yes') {
                            if(full.isAdmin == 'yes' && full.Phone!=null)
                                return full.Phone;
                            else if(full.isAdmin == 'no' && full.vr_Phone!=null)
                                return full.vr_Phone;
                            else
                                return 'Empty';
                        }
                        else
            ...
            //Website Address
            {
                ...
                "render":function( data, type, full, meta){
                    if(data!=''){
                        if(full.New_Ver == 'Yes') {
                            if(full.isAdmin == 'yes' && full.Website!=null)
                                return full.Website;
                            else if(full.isAdmin == 'no' && full.vr_Website!=null)
                                return full.vr_Website;
                            else
                                return 'Empty';
                        }
                        else
