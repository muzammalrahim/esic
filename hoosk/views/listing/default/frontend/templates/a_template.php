...
if(!empty($detail->Status_ID)){
    ...
    $Status = '<span style="background-color:'. $esic_status->color .';color:#ffffff;margin-top: 15px;" class="btn btn-xs">'.$esic_status->status.'</span>';
}
else{
    $Status =  '';
}
...
<div class="template-a">
    <?php if($showBanner){ ?>
    <div class="background-img-container banner-box">
        ...
        <div class="container">
            <div class="detail-box-container clearfix">
                <div class="col-md-4 logo-container">
                    <div class="logo-area">
                        <div class="main-social-container" style="text-align: center;">
