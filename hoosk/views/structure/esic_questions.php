...
if (isset($QuestionsAnswers) and !empty($QuestionsAnswers)) {
    foreach ($QuestionsAnswers as $key => $questionData) {
        ...
        if(!empty($PossibleSolutions) and isset($PossibleSolutions->type)){ ?>
          <fieldset class="questions" data-question-id="<?= $questionData->questionID;?>" data-question-type="<?= $PossibleSolutions->type;?>">
              <div class="form-group bg-shaded clearfix">
                  <div class="col-blocks col-xs-12 col-sm-12 col-md-8">
        ...
        ?>
                              <div class="col-blocks col-xs-3 col-sm-6 col-md-4" data-id="<?= $textBoxID;?>" data-type="textBoxes">
        ...
        ?>
                        <div class="col-blocks col-xs-12 col-sm-12 col-md-4" data-id="<?= $checkBoxID;?>" data-type="CheckBoxes">
        <?php
        ...
        ?>
                    <div class="col-blocks col-xs-3 col-sm-6 col-md-4 SelectBox" data-id="<?= $questionID;?>" data-type="SelectBox">
        <?php
        ...
        <?php 
                  ...
                  $classAdd = '';
                      if($isMulti){
                        ...
                        $classAdd = 'js-example-basic-multiple select2-active';
                      }
                  $Required = '';
                      if($isRequired){
        ...
        ?>
                    <select id="<?= $ItemNameID; ?>" name="<?= $ItemNameID; ?>" <?= $multi;?> <?= $Required;?>  class="form-control <?= $classAdd;?> ">
                ...
                foreach ($item->subItems as $key => $subItem) {
                    ...
                    switch ($type) {
                        case 'pre-populatedList':
                           ...
                           FrontEndPrePopulatedItemsView($this,$data);
                            break;
                        case 'subQuestion':
                            $data                 = '';
                            $data['subItemID']    = $radioItemID;
                            ...
                            FrontEndSubQuestionView($this,$data);
                            break;
                    }
                }
            }
