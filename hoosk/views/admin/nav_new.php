      ...
      var parseJsonAsHTMLTree = function(jsn) {
        ...
        jsn.forEach(function(item) {
          if (item.title && item.children) {
            result += '<li class="dropdown"><a class="drop-down-cusom" href="<?php echo BASE_URL; ?>/' + item.href + '">' + item.title + '<b class="caret"></b></a><i class="fa fa-angle-down fa-angle-custom pull-right"></i><ul class="dropdown-menu">';
