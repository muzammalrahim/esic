...
$lang['login_username']		= "Username or Email";
$lang['login_password']		= "Password";
$lang['login_signin']		= "Sign In";
$lang['login_reset']		= "Reset Password";
$lang['login_incorrect']	= "The Username & Password entered is incorrect.";
...
//Page Messges
$lang['page_message_dashboard'] = 'Welcome to your user dashboard, we think of it as a control panel to collate and manage one or many listings through the directory network. You’re on the front of the dash, which can be a little lonely if you’re new to ESIC Directory. Don’t worry, just navigate to your listing by the menu and feel free to announce your influence by listing extra strings to your bow';
$lang['page_message_manage_esic'] = 'Welcome to the ESIC dashboard, you are thinking isn’t one ESIC enough? Well the directory is built for scale, so those who are lucky enough to be engaged with plenty can control, collate and manage one or many listings through this page. All you need to do is drill into the ‘play button’ and you’re directly editing the listing. It’s that easy!';

$lang['page_message_manage_lawyer'] = 'Welcome to the Lawyer page for ESIC Directory, it’s here that you can update or add details of your Lawyer Services business. Please list details such as; the value proposition and professional credentials, and hopefully we can help you pair up with well-funded high growth innovation companies.';
$lang['page_message_manage_rndpartner'] = 'Welcome to the R&D Partner page for ESIC Directory, it’s here that you can update or add details of your R&D Services business. Please list details such as; the value proposition and professional credentials, and hopefully we can help you pair up with well-funded high growth innovation companies.';
$lang['page_message_manage_rndcosultant'] = 'Welcome to the R&D Consultants page for ESIC Directory, it’s here that you can update or add details of your R&D Consultant Services business. Please list details such as; the value proposition and professional credentials, and hopefully we can help you pair up with well-funded high growth innovation companies. Tip; consider duel listing in grant or tax categories if they fit your skill set.';
$lang['page_message_manage_taxadvisors'] = 'Welcome to the Tax Advisers page for ESIC Directory, it’s here that you can update or add details of your Tax Advisers Services business. Please list details such as; the value proposition and professional credentials, and hopefully we can help you pair up with well-funded high growth innovation companies. Tip; consider duel listing in grant or tax categories if they fit your skill set.';
$lang['page_message_manage_grantconsultant'] = 'Welcome to the Grant Consultants page for ESIC Directory, it’s here that you can update or add details of your Grant Consultants Services business. Please list details such as; the value proposition and professional credentials, and hopefully we can help you pair up with well-funded high growth innovation companies.Tip; consider duel listing in R&D or tax categories if they fit your skill set.';
$lang['page_message_manage_accelerator'] = 'Welcome to the Accelerator administration panel for ESIC Directory, it’s here that you can update or add details, contact methods, commencement date etc. Hopefully we can help you pair up with well-funded high growth innovation companies.';
//Listing Forms Choose Option Messages
$lang['choose_pagebuilder_questionaire'] = 'You can go straight to page builder or fill questionnaire , both of these can also editable from your profile.';
$lang['choose_pagebuilder'] = 'You can go straight to page builder, This can also be editable from your profile.';
$lang['listing_process_complete_guest'] ='Please Login to get more options.';
$lang['listing_process_complete_user'] = 'Click on Dashboard to go to your dashboard section to get full options.';
