...
require_once(APPPATH.'/third_party/Twitter/OAuth.php');
...
class TwitterOAuths {
	...
	/* Set api root url for media upload*/
	public $upload_root="https://upload.twitter.com/1.1/";
	/* Set timeout default. */
	public $timeout = 30;
	/* Set connect timeout. */
	...
	function oAuthRequest($url, $method, $parameters) {
		if($url=='media/upload'){
			$root_url=$this->upload_root;
		} else
			$root_url=$this->host;
		if (strrpos($url, 'https://') !== 0 && strrpos($url, 'http://') !== 0) {
			$url = "{$root_url}{$url}.{$this->format}";
		}
//		echo "<pre>";
//		echo  '$this->consumer';
//
